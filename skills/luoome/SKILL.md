---
name: luoome
description: Use when the user asks about their luoome portfolio, holdings, trades, PnL, stock quotes, tactics, research notes, company events, watch plans or structured investment advice. Operates through a connected luoome MCP server; provides advice and analysis but never places trades.
---
...
2. Identify the user's account, stock, holding, group, watch plan, event or advice subject before requesting details.
